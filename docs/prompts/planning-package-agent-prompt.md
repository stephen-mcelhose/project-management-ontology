...
```
templates/planning/{kebab-name}/entry.yaml
templates/planning/{kebab-name}/instructions.yaml
templates/planning/{kebab-name}/template.md
shapes/planning/{kebab-name}.shacl.ttl
```
...
Template pack built at `templates/planning/{name}/`.
SHACL shape at `shapes/planning/{name}.shacl.ttl`.
